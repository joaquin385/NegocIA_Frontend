...
const TablaAnalisisProveedores = () => {
  ...
  const productos = [
    { 
      ...
      categoria: 'Carnes', 
      costoUnitario: 216, 
      proveedorPrincipal: 'Suministros Rurales', 
    ...
    { 
      ...
      categoria: 'Lácteos', 
      costoUnitario: 291, 
      proveedorPrincipal: 'Distribuidora Nacional', 
    ...
    { 
      ...
      categoria: 'Granos', 
      costoUnitario: 350, 
      proveedorPrincipal: 'Suministros del Sur', 
    ...
    { 
      ...
      categoria: 'Verduras', 
      costoUnitario: 40, 
      proveedorPrincipal: 'Proveedor Premium', 
    ...
    { 
      id: 5, 
      idProducto: 'PR005', 
      nombre: 'Queso Manchego Importado', 
      categoria: 'Frutas', 
      costoUnitario: 481, 
      proveedorPrincipal: 'Proveedor Norte Ltda.', 
    ...
    { 
      id: 6, 
      idProducto: 'PR006', 
      nombre: 'Arroz Basmati Premium', 
      categoria: 'Bebidas', 
      costoUnitario: 33, 
      proveedorPrincipal: 'Comercial Este', 
    ...
    { 
      ...
      categoria: 'Snacks', 
      costoUnitario: 126, 
      proveedorPrincipal: 'Proveedor Metropolitano', 
    ...
    { 
      ...
      categoria: 'Limpieza', 
      costoUnitario: 134, 
      proveedorPrincipal: 'Mayorista Central', 
