...
const Tickets = () => {
  ...
  const datosCantidadTickets = [
    { fecha: '19/7', cantidad: 36 },
    { fecha: '20/7', cantidad: 41 },
    { fecha: '21/7', cantidad: 33 },
    { fecha: '22/7', cantidad: 49 },
    { fecha: '23/7', cantidad: 56 },
    { fecha: '24/7', cantidad: 43 },
    { fecha: '25/7', cantidad: 39 },
    { fecha: '26/7', cantidad: 46 },
    { fecha: '27/7', cantidad: 51 },
    { fecha: '28/7', cantidad: 40 },
    { fecha: '29/7', cantidad: 44 },
    { fecha: '30/7', cantidad: 50 },
    { fecha: '31/7', cantidad: 37 },
    { fecha: '1/8', cantidad: 41 },
    { fecha: '2/8', cantidad: 47 },
    { fecha: '3/8', cantidad: 42 },
    { fecha: '4/8', cantidad: 38 },
    { fecha: '5/8', cantidad: 45 },
    { fecha: '6/8', cantidad: 51 },
    { fecha: '7/8', cantidad: 40 },
    { fecha: '8/8', cantidad: 43 },
    { fecha: '9/8', cantidad: 49 },
    { fecha: '10/8', cantidad: 37 },
    { fecha: '11/8', cantidad: 40 },
    { fecha: '12/8', cantidad: 47 },
    { fecha: '13/8', cantidad: 42 },
    { fecha: '14/8', cantidad: 38 },
    { fecha: '15/8', cantidad: 44 },
    { fecha: '16/8', cantidad: 50 },
    { fecha: '17/8', cantidad: 39 },
    { fecha: '18/8', cantidad: 43 },
    { fecha: '19/8', cantidad: 49 },
    { fecha: '20/8', cantidad: 37 },
    { fecha: '21/8', cantidad: 40 },
    { fecha: '22/8', cantidad: 46 },
    { fecha: '23/8', cantidad: 41 },
    { fecha: '24/8', cantidad: 37 },
    { fecha: '25/8', cantidad: 44 },
    { fecha: '26/8', cantidad: 50 },
    { fecha: '27/8', cantidad: 38 }
  ]

  const datosTicketPromedio = [
    { fecha: '19/7', ticketPromedio: 228 },
    { fecha: '20/7', ticketPromedio: 232 },
    { fecha: '21/7', ticketPromedio: 236 },
    { fecha: '22/7', ticketPromedio: 229 },
    { fecha: '23/7', ticketPromedio: 229 },
    { fecha: '24/7', ticketPromedio: 228 },
    { fecha: '25/7', ticketPromedio: 228 },
    { fecha: '26/7', ticketPromedio: 228 },
    { fecha: '27/7', ticketPromedio: 231 },
    { fecha: '28/7', ticketPromedio: 230 },
    { fecha: '29/7', ticketPromedio: 230 },
    { fecha: '30/7', ticketPromedio: 230 },
    { fecha: '31/7', ticketPromedio: 232 },
    { fecha: '1/8', ticketPromedio: 229 },
    { fecha: '2/8', ticketPromedio: 232 },
    { fecha: '3/8', ticketPromedio: 231 },
    { fecha: '4/8', ticketPromedio: 232 },
    { fecha: '5/8', ticketPromedio: 229 },
    { fecha: '6/8', ticketPromedio: 229 },
    { fecha: '7/8', ticketPromedio: 228 },
    { fecha: '8/8', ticketPromedio: 230 },
    { fecha: '9/8', ticketPromedio: 231 },
    { fecha: '10/8', ticketPromedio: 230 },
    { fecha: '11/8', ticketPromedio: 233 },
    { fecha: '12/8', ticketPromedio: 230 },
    { fecha: '13/8', ticketPromedio: 229 },
    { fecha: '14/8', ticketPromedio: 229 },
    { fecha: '15/8', ticketPromedio: 232 },
    { fecha: '16/8', ticketPromedio: 232 },
    { fecha: '17/8', ticketPromedio: 231 },
    { fecha: '18/8', ticketPromedio: 228 },
    { fecha: '19/8', ticketPromedio: 229 },
    { fecha: '20/8', ticketPromedio: 227 },
    { fecha: '21/8', ticketPromedio: 230 },
    { fecha: '22/8', ticketPromedio: 233 },
    { fecha: '23/8', ticketPromedio: 232 },
    { fecha: '24/8', ticketPromedio: 230 },
    { fecha: '25/8', ticketPromedio: 230 },
    { fecha: '26/8', ticketPromedio: 230 },
    { fecha: '27/8', ticketPromedio: 234 }
  ]
    ...
    subsecciones: [
      {
        ...
        metricas: [
          { nombre: "Cantidad de tickets", valor: 1250, formato: "numero" },
          { nombre: "Valor promedio ($)", valor: 230, formato: "moneda" },
          { nombre: "Unidades promedio", valor: 1.5, formato: "numero" }
        ]
      },
      {
        titulo: "Distribución del ticket",
        metricas: [
          { nombre: "Ticket máximo", valor: 850, formato: "moneda" },
          { nombre: "Ticket mínimo", valor: 25, formato: "moneda" }
        ]
      },
      {
        titulo: "Segmentación por valor",
        metricas: [
          { nombre: "% tickets bajo valor", valor: 55, formato: "porcentaje" },
          { nombre: "% tickets medio valor", valor: 32, formato: "porcentaje" },
          { nombre: "% tickets alto valor", valor: 13, formato: "porcentaje" }
        ]
      }
    ]
  }
