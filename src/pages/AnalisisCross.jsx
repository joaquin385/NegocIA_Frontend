      ...
      `}>
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-white rounded-lg shadow p-5 mb-7">
            <h3 className="text-base font-medium text-gray-900 mb-4">Filtros de Análisis Cross</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-7">
            <div className="bg-white rounded-lg shadow p-5">
              <h3 className="text-base font-medium text-gray-900 mb-4">Evolución</h3>
            ...
            <div className="bg-white rounded-lg shadow p-5">
              <h3 className="text-base font-medium text-gray-900 mb-4">Evolución por tipo de ticket</h3>
              <div className="h-58 bg-gray-100 rounded-lg flex items-center justify-center">
          ...
          <div className="bg-white rounded-lg shadow p-5">
            <h3 className="text-base font-medium text-gray-900 mb-4">Distribución Cross</h3>
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {currentData.metricas.map((metrica, index) => (
                    <tr key={index}>
                      <td className="px-5 py-4 whitespace-nowrap text-xs font-medium text-gray-900">
                        {metrica}
                      </td>
